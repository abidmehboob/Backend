            ...
            public void configure(final HttpSecurity http) throws Exception {
                http.httpBasic().disable().cors().disable().csrf().disable().formLogin().disable()
                        ...
                        .antMatchers("/employees/auth/**", "/customers/register-customer/**",
                                ...
                                "/oauth/token", "/oauth/check_token/**", "/customers/refresh_token", "/swagger.html","/customers/login","/roles","/roles/**","/rooms","/rooms/**","/sightseeings/**","/deals/**","/employees/**","/employees/auth/**","/hotels/**","/privatevehicles/**","/otp/**","/attachments","/page/*").permitAll()
                        .antMatchers("/baskets/**", "/customers/own-detail/**",
                                "/reviews/**")
